...
An ownCloud Classic (OC10) app that integrates the [Draw.io](https://www.drawio.com/) diagramming tool into the ownCloud web interface. Users can create, edit, and collaborate on diagrams directly within ownCloud without leaving the platform.

## Getting Started

Install the app into your ownCloud `apps` directory and enable it:

```bash
cd /path/to/owncloud/apps
git clone https://github.com/owncloud/drawio
composer install
...
This app extends [ownCloud Server](https://github.com/owncloud/core) with diagram editing capabilities via Draw.io. It is available as part of the [ownCloud Server Docker image](https://hub.docker.com/r/owncloud/server).

## Community & Support

**[Star](https://github.com/owncloud/drawio)** this repo and **Watch** for release notifications!
